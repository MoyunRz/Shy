...
public class LeeJSONResult {
    ...
    public static LeeJSONResult pageBuild(Integer code,Integer count,Object data) {
        return new LeeJSONResult(code,count,data);
    }
...
//    }
    ...
    public LeeJSONResult(Integer code,Integer count,Object data) {
        this.code = code;
        this.count = count;
        this.data = data;
    }
